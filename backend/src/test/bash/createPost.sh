...
curl -X POST \
    -H "Authorization: Bearer eyJhbGcxOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwidXNlciI6ImFydHVybyIsImlhdCI6MTYzNDI2MTAxMn0._oLgA2_4h83BnnIIWVttqRPzRuaFSQGTnS7-C9T2xl4" \
    http://localhost:3001/Post
